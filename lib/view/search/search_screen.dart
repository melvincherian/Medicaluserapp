...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Search Medicines', style: TextStyle(fontWeight: FontWeight.bold)),
//         backgroundColor: const Color(0xFF5931DD),
//         foregroundColor: Colors.white,
//         elevation: 0,
//         leading: IconButton(
...
//                       ? GestureDetector(
//                         onTap: () {
//                           Navigator.push(context, MaterialPageRoute(builder: (context)=>ScannedMedicineScreen(mrp: medicine.mrp.round(),medicineId: medicine.medicineId,)));
//                         },
//                         child: Image.network(
//                             medicine.images.first,
//                             width: 80,
