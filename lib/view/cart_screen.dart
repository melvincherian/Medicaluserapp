...
class _CartScreenState extends State<CartScreen>
            ...
            children: [
                ...
                child: IconButton(
                  ...
                  onPressed: item.quantity <= 1
                      ...
                      : ()  {
                          ...
                          // setState(() {});
                         cartProvider.decreaseQuantity(item.medicineId);
                        },
                  padding: EdgeInsets.zero,
                  constraints: const BoxConstraints(),
                ),
              ...
              AnimatedContainer(
                ...
                child: IconButton(
                  icon: const Icon(Icons.add, size: 16, color: Colors.white),
                  onPressed: ()  {
                     cartProvider.increaseQuantity(item.medicineId);
                  },
                  padding: EdgeInsets.zero,
                  constraints: const BoxConstraints(),
                ),
  ...
  //           ),
  //         ),
  //         child: cartProvider.isLoading && cartProvider.cart.items.isEmpty
  //             ? const SizedBox(
  //                 width: 20,
  //                 height: 20,
  //                 child: CircularProgressIndicator(
