        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Consumer<LocationProvider>(
                builder: (context, locationProvider, child) {
                  final isLoading = locationProvider?.isLoading == true;
                  final addressParts = (locationProvider?.address ?? '')
                      .split(',')
                      .map((e) => e.trim())
                      .toList();
                  final primaryAddress = addressParts.isNotEmpty && addressParts[0].isNotEmpty
                      ? addressParts[0]
                      : 'No location set';
                  final secondaryAddress = addressParts.length > 1
                      ? addressParts.sublist(1).take(2).join(', ')
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 6),
                                            // Green dot — dimmed while loading
                                            Container(
                                              width: 4,
                                              height: 4,
                                              decoration: BoxDecoration(
                                        ...
                                        // Primary address — shimmer while loading
                                        isLoading
                                            ? const ShimmerLoading(
                                                width: 150,
                                                height: 18,
                                        ...
                                        // Secondary address — shimmer while loading
                                        isLoading
                                            ? const ShimmerLoading(
                                                width: 110,
                                                height: 13,
